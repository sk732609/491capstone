...
import {Text, View, StyleSheet, ScrollView, Image, TextInput, TouchableOpacity, Alert} from 'react-native';
import {
  Table,
  TableWrapper,
  Row,
...
export default class HowTo extends Component{ 
  constructor(props) {
    ...
    this.state = {
      token: '',
      tableHead: ['Title', 'Link', 'View_Count'],
      tableData: [],
    };
  } 
  ...
  getHowTo = async () => {
    var checkIdAPIURL = 'https://njitmobileapp.navitend.co//getHowTo.php';
    ...
    return(
        ...
        <View style={styles.mainView}>
            <View style = {styles.topView}>
                <Unfold style = {styles.menuImage} name = 'menu-fold' size = {40} onPress = {()=> this.props.navigation.toggleDrawer()} />
